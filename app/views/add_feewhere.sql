...
#create view members as  SELECT `id`, `surname`, `forename`, `membnum`, `phone`, `mobile`, `email`, `membtype`, `location`, `paidthisyear`, `amtpaidthisyear`, `datejoined`, `datepaid`, `feeewhere`, `created_at`, `updated_at` FROM `members` where u3ayear='2014-2015';

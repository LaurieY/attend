...
//require_once 'vendor/HTTP/Request2/Adapter.php'; //LEY
require_once 'HTTP/Request2/Adapter.php'; //LEY

/** Socket wrapper class */
//require_once 'vendor/HTTP/Request2/SocketWrapper.php'; //LEY
require_once 'HTTP/Request2/SocketWrapper.php'; //LEY
...
class HTTP_Request2_Adapter_Socket extends HTTP_Request2_Adapter
{
    ...
    protected function connect()
    {
        ...
        if ($keepAlive && !empty(self::$sockets[$socketKey])
            ...
            if ($socksProxy) {
                require_once 'vendor/HTTP/Request2/SOCKS5.php'; // LEY
